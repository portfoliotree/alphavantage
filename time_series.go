...
type SymbolSearchRow struct {
	...
	MatchScore  string `column-name:"matchScore"`
}
...
type TimeSeriesDailyAdjustedRow struct {
	...
	Low              string `column-name:"low"`
	Close            string `column-name:"close"`
	AdjustedClose    string `column-name:"adjusted_close"`
	Volume           string `column-name:"volume"`
...
type TimeSeriesMonthlyAdjustedRow struct {
	...
	Low            string `column-name:"low"`
	Close          string `column-name:"close"`
	AdjustedClose  string `column-name:"adjusted close"`
	Volume         string `column-name:"volume"`
	DividendAmount string `column-name:"dividend amount"`
}
